...
public enum ErrorCode {
    ...
    NO_LIKE(BAD_REQUEST, "좋아요를 누르지 않았습니다"),
    ...
    DUPLICATE_PROJECT_LIKE(BAD_REQUEST, "이미 좋아요를 누른 프로젝트입니다."),

    DUPLICATE_PROJECT_PARTICIPATION(BAD_REQUEST, "해당 멤버는 이미 프로젝트에 참여중 입니다."),
    VALIDATION_FAILED(BAD_REQUEST,"올바른 값을 입력해주세요."),
    MESSAGE_NOT_READABLE(BAD_REQUEST, "Failed to read request"),
    TYPE_MISMATCH(BAD_REQUEST, "Failed to convert");
